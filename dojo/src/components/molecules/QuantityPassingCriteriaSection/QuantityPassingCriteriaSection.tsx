...
import { Target, Save, Edit3, X, Trash2, Plus, Calendar } from "lucide-react";
...
const goToDailySettings = () => {
    if (!selectedDepartment || !selectedLevel) {
      alert("Please select both Department and Level first.");
      return;
    }
    Navigate("/quantitydaysettings", {
      state: { departmentId: selectedDepartment, levelId: selectedLevel },
    });
  };
  return (
    <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-200">
      ...
      {!selectedDepartment || !selectedLevel ? (
        ...
        <div className="space-y-4">
          ...
          <button
              onClick={goToDailySettings}
              className="flex items-center justify-center gap-2 px-5 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors font-medium"
            >
