...
//   line1Color = '#4f46e5',
//   line2Color = '#10b981',
//   area1Color = 'rgba(99, 102, 241, 0.1)',
...
const LineGraph: React.FC<LineGraphProps> = ({
  ...
  responsive = true,
  maintainAspectRatio = false,
  // ✅ Default to dark text (Light Mode) if not provided
  textColor = '#333333', 
  gridColor = '#e5e7eb'
}) => {
  const chartData: ChartData<'line', number[], string> = {
  ...
  const options: ChartOptions<"line"> = {
    ...
    plugins: {
      legend: {
        ...
        align: "start",
        labels: {
          color: textColor, // ✅ Use dynamic text color for Legend
          font: { size: 12 },
          boxWidth: 10,
          usePointStyle: true,
          pointStyle: "circle",
      ...
      tooltip: {
        enabled: true,
        displayColors: true,
        titleColor: '#fff', // Tooltips usually look best with fixed white text on dark bg
        bodyColor: '#fff',
