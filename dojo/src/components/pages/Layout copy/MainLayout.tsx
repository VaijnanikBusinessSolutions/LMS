...
import { NavigationRailNew } from './NavigationRail';
import { ExpandableSidePanelNew } from './ExpandableSidePanel';
...
import { FooterNew } from "../../organisms/Footer/FooterNew";

const localhostoutNew = () => {
...
export default localhostoutNew;