...
const Notification: React.FC = () => {
  ...
  const TrainingCard: React.FC<{ session: TrainingSession }> = ({ session }) => (
    <div className="bg-surface rounded-2xl shadow-lg border border-border p-6 hover:shadow-xl transition-all hover:-translate-y-1">
      <div className="flex items-start justify-between mb-4">
        ...
        <span className={`px-4 py-2 text-sm font-bold rounded-xl border ${getStatusStyles(session.status)}`}>
      ...
      <div className="space-y-3 text-base text-text font-medium">
        ...
        <div className="flex items-center space-x-3 pt-3 border-t border-border mt-3">
          <Users className="w-5 h-5 text-blue-600" />
          <span className="font-bold text-blue-700">{session.employees.length} participants</span>
        </div>
      </div>
      ...
      <div className="max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-muted mt-1 text-lg font-medium">Stay updated on training schedules</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-surface rounded-3xl shadow-xl border border-border mb-8 overflow-hidden">
          ...
          <div className="p-8">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div className="space-y-3">
                ...
                <select
                  ...
                  onChange={(e) => setSelectedMonth(parseInt(e.target.value))}
                  disabled={viewMode === 'year'}
                  className="w-full px-5 py-4 border-2 border-border rounded-2xl focus:outline-none focus:ring-4 focus:ring-purple-100 focus:border-purple-500 bg-background text-text shadow-sm transition-all text-base font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {monthNames.map((month, index) => (
                    <option key={index} value={index}>{month}</option>
                  ))}
            ...
            {/* Current Filter Display */}
            <div className="mt-6 p-5 bg-purple-50/50 border border-purple-100 rounded-2xl">
              <div className="flex items-center space-x-3">
                <TrendingUp className="w-6 h-6 text-purple-600" />
        ...
        {/* Upcoming Trainings Alert */}
        {upcomingCount > 0 && (
          <div className="bg-blue-50/50 border border-blue-200 rounded-2xl p-6 mb-8 shadow-sm">
            <div className="flex items-center space-x-4">
              <div className="bg-blue-600 p-3 rounded-xl">
                <Bell className="w-6 h-6 text-white" />
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div className="bg-surface p-6 rounded-2xl border border-border shadow-lg">
            ...
            <div className="text-sm text-muted font-bold uppercase tracking-wider">Scheduled</div>
          </div>
          ...
          <div className="bg-surface p-6 rounded-2xl border border-border shadow-lg">
            ...
            <div className="text-sm text-muted font-bold uppercase tracking-wider">Completed</div>
          </div>
        </div>
          ...
          <div className="p-8 bg-background">
            {filteredSessions.length > 0 ? (
              ...
              <div className="text-center py-16">
                ...
                <p className="text-muted font-medium text-lg mb-6">
                  No trainings scheduled for the selected period.
                </p>
                <button
                  onClick={() => {
