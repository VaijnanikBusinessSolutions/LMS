            ...
            <div className="w-full mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
                {subtopics.map((subtopic) => (
                    <div
                        ...
                        // className="w-full h-20 rounded-lg bg-gray-200 animate-pulse flex flex-col justify-center items-center p-2"
                        className="w-full h-20 rounded-lg shadow-md flex flex-col justify-center items-center text-white p-2"
                    >
