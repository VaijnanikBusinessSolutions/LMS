    ...
    return (
        <div className='bg-surface p-8 rounded-3xl shadow-sm border border-border hover:shadow-md transition-shadow duration-300 h-[450px] flex flex-col'>
            <div className='flex items-center mb-6'>
                ...
                <h2 className='text-2xl font-bold text-text'>Operator Skills</h2>
            </div>
            <div className='flex-1 overflow-y-auto hide-scrollbar'>
                {skills.length > 0 ? (
                    <div className='space-y-4'>
                        {skills.map((skill) => (
                            <div key={skill.id} className='bg-background p-5 rounded-2xl border-l-4 border-green-500 shadow-sm hover:shadow-md transition-all duration-200'>
                                <h3 className='font-bold text-lg text-text mb-2'>{skill.station_name || "General Skill"}</h3>
                                <div className='flex justify-between text-base mb-1'>
                    ...
                    <div className='flex items-center justify-center h-full text-muted text-lg'>No operator skills recorded</div>
                )}
            </div>
        </div>
    );
