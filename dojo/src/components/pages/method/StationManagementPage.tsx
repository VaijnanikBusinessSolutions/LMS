...
// src/components/pages/StationManagementPage.tsx
  ...
  return (
    <div className="min-h-screen bg-background text-text transition-colors duration-300">
      <div className="container mx-auto px-4 py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-text mb-2">Station Management</h1>
          <p className="text-lg text-muted">Monitor and configure station settings and configurations</p>
        </div>
        ...
        {/* Tab Content */}
        <div className="tab-content bg-surface rounded-b-2xl p-6 border-x border-b border-border shadow-sm min-h-[500px]">
          {activeTab === 'station-requirement' && <StationRequirementPage />}
          {activeTab === 'station-settings' && <StationSettings />}
          {activeTab === 'station-configuration' && <StationConfiguration />}
        </div>
