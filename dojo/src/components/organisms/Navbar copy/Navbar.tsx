...
// import { NotificationItemNew } from './NotificationDrawer';
import { useTheme } from '../../../theme/ThemeContext';
import { UserDropdownNew } from '../../molecules/UserDropdown copy/UserDropdown';
import { NotificationDrawerNew } from './NotificationDrawer';
  ...
  return (
    <>
      ...
      >
        ...
        className="flex items-center gap-2 px-3 py-2 rounded-lg bg-indigo-600 text-white font-bold text-[10px] tracking-wider uppercase hover:bg-indigo-700 transition-colors shadow-sm"
      >
        <RefreshCw size={14} />
        Modern Mode
      </button>
...
//     <>
//       <motion.nav 
//         className="fixed top-0 left-0 right-0 z-50 h-16 md:h-[72px] px-3 md:px-6 flex justify-between items-center transition-all duration-500"
//         style={{
