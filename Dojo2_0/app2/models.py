...
# =====================================================
# 2. RULE ENGINE (Links Hierarchy to Skills)
# =====================================================

class CompetencyRule(models.Model):
    """
    Defines required skills for a specific Department/Group/Designation.
    Uses string fields for hierarchy to match LMSProfile.
    """
